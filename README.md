...
- **Iter25**. Обмен данными по протоколу gRPC.
  - [ ] Добавьте возможность обмена данными между сервером и агентом по протоколу gRPC.
  - [ ] Поддержите все возможности конфигурации gRPC-сервера и агента аналогично конфигурациям HTTP-сервера.
